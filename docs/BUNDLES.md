...
Found a skill that should be in a bundle? Or want to create a new bundle? [Open an issue](https://github.com/direkturcrypto/openclaw-awesome-skills/issues) or submit a PR!
